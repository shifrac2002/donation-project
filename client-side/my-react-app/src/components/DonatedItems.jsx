...
function DonatedItems(props) {
    ...
    useEffect(() => {
        async function fetchAllDonation() {
            debugger
            const url = `${process.env.REACT_APP_API_URL}/api/item/donatedItems/${props.ShulId}`;
            ...
            let res = await fetch(`${process.env.REACT_APP_API_URL}/api/shul/${props.ShulId}/getFreeDonation`);
            console.log(res);
