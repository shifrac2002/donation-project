...
function Dedications(props) {
    ...
    useEffect(() => {
        async function allDedications() {
            let result1 = await fetch(`${process.env.REACT_APP_API_URL}/api/shul/${props.ShulId}/itemsDedication`);
            ...
            let result2 = await fetch(`${process.env.REACT_APP_API_URL}/api/shul/${props.ShulId}/freeDedication`);
    ...
    async function handlingItemDedication(id) {
        let data = { id: id }
        console.log(data);
        const url = `${process.env.REACT_APP_API_URL}/api/dedication/itemHandling`;
    ...
    async function handlingFreeDedication(id) {
        let data = { id: id }
        console.log(data);
        const url = `${process.env.REACT_APP_API_URL}/api/dedication/freeHandling`;
        let response = await fetch(url, {
            method: 'PUT',
            headers: {
                'Accept': 'application/json',
