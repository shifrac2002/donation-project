...
CREATE TABLE `customers` (
  ...
  CONSTRAINT `customers_ibfk_3` FOREIGN KEY (`ShulId`) REFERENCES `shuls` (`ShulId`)
...
INSERT INTO `customers` VALUES (1,'כהן','0583265341','חיים','haim@gmail.com',1,'123AAaa',2),(2,'לוי','0526746532','משה','moshe@gmail.com',2,'123AAaa',11),(3,'בן מנשה','0556445258','משה','qqqq@gmail.com',1,'123',4),(4,'רוזנבלט','0556742555','אריה','qqqq@gmail.com',2,'123',9),(5,'רקנאטי','44444','יהודה','uuuuu}',1,'234',5),(6,'פרנק','0551','מאיר','shifrac2002@gmail.com',1,'123',6),(7,'מונסונגו','0551','אליהו','ee',1,'123',NULL),(8,'חסון','0829909','דן','rjhuig',1,'32345',NULL),(9,'קליין','0829909','גד','rjhuig',1,'32345',NULL),(10,'שרעבני','2345','חיים','jjsa',2,'32345',4),(11,'ווינגרטן','2345','משה','jjsa',2,'32345',5),(12,'קאזין','2345','ראובן','jjsa',2,'32345',5),(13,'מלכה','32456','אסתר','vdg ',2,'3245',6),(14,'רוזנר','2345','שרה','w',2,'23',7),(15,'רטנר','123','שירה','AAAA',2,'1111',12),(16,'פוקס','1234567','שמעון','111',1,'111',NULL),(17,'שפיגלמן','123456','מיכאל','2',1,'2',7),(18,'בירנבוים','543','רפאל','33',1,'33',NULL),(19,'לוי','3458','ישי','444',1,'444',NULL),(20,'לוי','2345','שלמה','5',1,'5',NULL),(21,'מואדב','3657','זבולון','qqww',1,'1234356',8),(22,'שמלה','1234','יעקב','pp',1,'0',NULL),(23,'בן אדיבה','3','אברהם','34',1,'34',NULL),(24,'שטריכר','123','לוי','123',1,'123',NULL),(25,'כהן','87','מאיר','00',1,'0',9),(26,'כהן','34567890','מאיר','99',1,'99',NULL),(27,'לוי','546','ישי','0000',1,'0',10),(28,'לוי','44','יצחק','44',1,'44',NULL),(29,'לוי','23','יעקב','88',1,'88',11),(30,'בלוי','3456','משה','777',1,'777',12),(31,'בויאר','2345','דו','66',1,'66',NULL),(32,'לינקר','23456789','ראובן','888',1,'888',NULL),(33,'בן עמרם','34567','גד','oooo',1,'0',NULL),(34,'אמיניאן','1234','שמעון','tyty',1,'33',NULL),(35,'רוטמן','2345678','רפאל','שדגכעיח1342',1,'1234567',NULL),(36,'סויסה','23456','בנימין','bbbb',1,'56789',NULL),(37,'מהרשל','2345678','יוסף','dfg',1,'45678',NULL),(38,'איבגי','345678','אהרון',' sdfg',1,'34567',NULL),(39,'פרחים','0987654','יוסי','גכעיח',1,'4568790',NULL),(40,'קלימן','345678','בני','כעיח',2,'34567',2),(41,'ספטנר','234','קובי','torem',2,'1234',2),(42,'פורוש','050124542','בני','wwww',2,'123456',3),(43,'פורוש','021200021','דן','ccccc',1,'12345',NULL),(44,'חסון','0583279290','גד','dvorah@gmail.com',1,'1234',NULL),(45,'כהן','1112223334','דוד','a@abc.com',1,'aaabbb5',NULL),(46,'יונה','12343','חיים','a2DDD',1,'1111',NULL),(47,'לוי','457897','לוי','wqwqwqwq',1,'hghghghhgh',NULL),(48,'לוי','11111111111','יהודה','qqq',1,'1111111',NULL),(66,'לוי','0533211252','שלום','shifrac2002@gmail.com',2,'s1234',29),(68,'לוי','0556742540','שלום','shifrac2002@gmail.com',1,'S12345',29),(69,'דוד','0556887512','חי','S2@gmail.com',1,'ddd',30);
...
INSERT INTO `donations` VALUES (1,8,6,6,NULL),(2,25,6,7,'u'),(3,23,30,10,'u'),(4,23,10,1,'u'),(14,8,1,2,'u'),(21,23,3,3,'להצלחת חגי בן אסתר'),(22,23,1,6,'להצלחת שלום בן משה'),(23,23,1,6,'aaaaa'),(24,23,1,6,NULL);
...
INSERT INTO `freedonation` VALUES (1,'240',NULL,1,3),(2,'300','fv',2,3),(3,'3544',NULL,1,2),(4,'33333','frhtuyerf',3,4),(5,'343',NULL,4,2),(7,'33333','eeeeeeee',4,4),(8,'333333333333',NULL,2,2),(9,'99999999999','4',2,2);
...
CREATE TABLE `shuls` (
  ...
  `NameShul` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `Customer` int NOT NULL,
...
INSERT INTO `shuls` VALUES (2,'שפתי חיים',1,' ירושלים רחוב הרב אלישיב 12','http://localhost:6200/shul1.jpg'),(3,'קרעטשנף',3,'טבריה רחוב אחוה6','http://localhost:6200/shul2.jpg'),(4,'מאקווא',4,'בני ברק רחוב כהנמן 4','http://localhost:6200/shul3.jpg'),(5,'אוהל תמר',5,'ירושלים רחוב ירמיהו 3','http://localhost:6200/shul4.jpg'),(6,'קהילות יעקב',6,'ירושלים רחוב רוזנבלט 2','http://localhost:6200/shul5.jpg'),(7,'החורבה',17,'ירושלים הרובע היהודי 3','http://localhost:6200/shul7.jpg'),(8,'הדרת מלך',21,'ירושלים הרב פרנק 45','http://localhost:6200/shul9.jpg'),(9,'בעלזא',25,'ירושלים שמואל הנביא 23','http://localhost:6200/shul10.jpg'),(10,'תולדות אהרון',27,'טבריה אחוה 3','http://localhost:6200/toldotAaron.jpg'),(11,'זוהר התורה',29,'ירושלים כלנית 3','http://localhost:6200/zoaratorah.jpg'),(12,'קהילות ישראל',30,'ירושלים הגפן 5','http://localhost:6200/keilotIsrael.jpg'),(29,'בית יצחק',66,'ירושלים רמת שלמה דרוק 99','http://localhost:6200/שיח יצחק.jpg'),(30,'הליכות עולם',69,'תל אביב מנחם בגין 33','http://localhost:6200/הליכות עולם.jpg');
...
-- Dump completed on 2025-08-01  1:59:38
